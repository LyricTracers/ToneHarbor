...
@riverpod
Future<String> coverUrlByArtist(Ref ref, {required String artistName}) async {
  final link = ref.keepAlive();
  try {
    return _getCoverUrlByArtist(ref: ref, artistName: artistName);
  } finally {
    link.close();
  }
}
...
Future<String> _getCoverUrlByArtist({
  required Ref ref,
