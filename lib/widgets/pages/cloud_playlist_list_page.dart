...
class CloudPlaylistListPage<T extends ExtraProvider<CloudMusicPlaylistDataList>>
    extends HookConsumerWidget {
  final $AsyncNotifierProvider<T, CloudMusicPlaylistDataList> baseProvider;
  final String title;

  const CloudPlaylistListPage({
    super.key,
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Column(
      ...
      children: [
        ...
        Expanded(child: CloudPlaylistsCat(baseProvider: baseProvider)),
      ],
    );
  }
}
